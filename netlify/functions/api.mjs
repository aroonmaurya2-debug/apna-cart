const getApiBase = () => String(process.env.API_BASE_URL || 'https://apna-cart-2rcq.onrender.com').replace(/\/$/, '')
...
export const handler = async (event) => {
  ...
  return { statusCode: upstream.status, headers: responseHeaders, body: responseBody }
}
