...
export default function CustomerFeatures() {
  ...
  return <>
    ...
    {open && <div style={{ position:'fixed', right:14, bottom:24, zIndex:9998, width:'min(360px, calc(100vw - 28px))', maxHeight:'70vh', overflow:'auto', background:'#fff', borderRadius:18, boxShadow:'0 12px 40px rgba(0,0,0,.25)', border:'1px solid #eee', padding:16 }}>
