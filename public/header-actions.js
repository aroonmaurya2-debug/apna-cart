(function(){
  ...
  function setup(){
    ...
    if(!header.querySelector('.referral-header-button')){
      ...
      b.className='referral-header-button'; b.type='button'; b.setAttribute('aria-label','Refer and Earn'); b.title='Refer & Earn';
    ...
    var wish=header.querySelector('.wishlist-header-button'), cart=header.querySelector('.cart-head');
    if(wish && cart && wish.nextSibling!==cart) header.insertBefore(wish,cart);
  }
